...
| 24 varianti `forest_tree` adulto/giovane | Progetto Local Action Sandbox | Fogli sorgente forniti dall'autore del progetto, `assets/environment/top_down/source_sheets/*tree_asset_sheet.png` | Originali del progetto | Crop deterministico `4x2` su canvas `444x444`; checkerboard convertito in alpha, matte contratto di 2 px e colore di bordo ricampionato dall'interno; pool dedicati a Pianura, Pianura Ardente e Tundra Gelata |
