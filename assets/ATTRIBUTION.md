...
| 191 raster terreno/cliff per bioma | Progetto Iso Local Sandbox con OpenAI image generation | Generazione interna, `assets/environment/isometric/generated_images/` | Originali del progetto | Cornici e gutter rimossi; matte dei cutout convertito in alpha da `prepare_generated_biome_assets.gd`; 129 asset attivi e set `desert`/`forest` non assegnati |
