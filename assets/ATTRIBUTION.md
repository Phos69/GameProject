...
| Contratto asset ambiente isometrico v10 | Progetto Iso Local Sandbox | `assets/environment/isometric/manifest.json` | Originali del progetto | Inventario asset-driven con SVG, raster e risorse Texture2D/AtlasTexture; fallback espliciti e nessun asset esterno obbligatorio |
| Asset ambiente SVG generati | Progetto Iso Local Sandbox | `assets/environment/isometric/**/*.svg` | Originali del progetto | Generati da `tools/generate_isometric_environment_assets.gd`; 95 path SVG attivi nel manifest, con sorgenti sostituite conservate in-repo |
| 195 raster terreno/cliff per bioma | Progetto Iso Local Sandbox con OpenAI image generation | Generazione interna, `assets/environment/isometric/generated_images/` | Originali del progetto | Cornici e gutter rimossi; matte dei cutout convertito in alpha da `prepare_generated_biome_assets.gd`; 133 asset attivi inclusi i road border definiti e set `desert`/`forest` non assegnati |
...
| Atlas oggetti dei cinque biomi | Progetto Iso Local Sandbox con OpenAI image generation | Generazione interna 2026-07-13, `assets/environment/isometric/concepts/` + `objects/generated_props/` | Originali del progetto | Cinque tavole 2x2 su chroma key convertito in alpha con despill; 20 regioni AtlasTexture usate dal runtime per 23 ID, senza ricampionamento |
