...
| Asset ambiente SVG generati | Progetto Iso Local Sandbox | `assets/environment/isometric/**/*.svg` | Originali del progetto | Generati da `tools/generate_isometric_environment_assets.gd`; 75 placeholder asset-driven sostituibili |
