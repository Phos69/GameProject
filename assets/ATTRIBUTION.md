...
| Asset ambiente SVG generati | Progetto Local Action Sandbox | `assets/environment/top_down/**/*.svg` | Originali del progetto | Generati da `tools/generate_top_down_environment_assets.gd`; 118 path SVG attivi nel manifest |
...
| 23 prop cardinali individuali | Progetto Local Action Sandbox | `assets/environment/top_down/objects/generated_props/*.svg` | Originali del progetto | Generati internamente con source `project_svg_generator` e attribution `environment_top_down_internal`; sostituiscono le 23 risorse AtlasTexture `.tres` e le cinque tavole concept raster rimosse |
