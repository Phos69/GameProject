...
| Audit migrazione isometrica | Milestone 1-9 PASS, Milestone 10.1-10.5 PASS con polish strade diagonali, SVG oggetti specifici e loader runtime non-placeholder | `docs/isometric_generation_audit_roadmap.md`, manifest ambiente v7, `BiomeTileLayer`, `IsometricTileResolver`, `IsometricEnvironmentObjectFactory`, `IsometricSvgTextureLoader`, `tools/generate_isometric_environment_assets.gd`, smoke Milestone 10.1-10.5 | Proseguire `ISO-001` con la Milestone 10.6 su vuoto, cliff e danno da caduta asset-driven |
...
- Stato: Milestone 1-9 completate il 2026-06-17 (la 8 anticipata su richiesta);
  ...
  dedicate e loader runtime non-placeholder; la prossima azione e la Milestone
  10.6 su vuoto, cliff e danno da caduta asset-driven.
