...
| Asset isometrici ambiente | PASS; footprint v9, albero/roccia 3x3, sei materiali terreno forestale e cliff void completati il 2026-06-21 | Smoke ostacoli 3x3, `tests/forest_grass_generated_texture_smoke_test.gd`, `tests/void_cliff_generated_texture_smoke_test.gd`, QA `build/qa/obstacle_3x3/`, `build/qa/forest_surfaces/` e `build/qa/void_cliffs/`, manifest v9 | QA manuale player davanti/dietro, `F9` e continuita terreno/cliff su confini reali nel playtest Milestone 11 |
