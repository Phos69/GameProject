...
| Asset isometrici ambiente | PASS; footprint v9, albero 3x3, aree rocciose 15-30 celle con kit cliff 3D ascendente, faccia sud e occlusione nord per-player, sei materiali terreno forestale e cliff void completati il 2026-06-22 | `tests/scalable_obstacle_smoke_test.gd`, `tests/rock_area_visual_qa.gd`, `tests/rock_cliff_generated_visual_qa.gd`, smoke ostacoli 3x3, texture forest/cliff e QA `build/qa/scalable_rocks/`, `build/qa/rock_cliffs/`, `build/qa/void_cliffs/` | QA manuale co-op con player simultanei dietro/davanti, `F9`, continuita top/bordi H/V e collisione player/proiettili nel playtest Milestone 11 |
