...
func _draw_boundary() -> void:
	BIOME_OBSTACLE_PAINTER.draw_boundary(self, obstacle_size, primary_color, accent_color)

func _draw_toxic_boundary_wall() -> void:
	BIOME_OBSTACLE_PAINTER.draw_toxic_boundary_wall(self, obstacle_size, primary_color, accent_color)

func _draw_lava_boundary() -> void:
	BIOME_OBSTACLE_PAINTER.draw_lava_boundary(self, obstacle_size, primary_color, accent_color)

func _draw_ice_boundary() -> void:
	BIOME_OBSTACLE_PAINTER.draw_ice_boundary(self, obstacle_size, primary_color, accent_color)

func _draw_deep_water_boundary() -> void:
	BIOME_OBSTACLE_PAINTER.draw_deep_water_boundary(self, obstacle_size, primary_color, accent_color)
