...
const ROAD_WIDTH_TILES: int = 14
const SECONDARY_ROAD_WIDTH_TILES: int = 7
const PASSAGE_WIDTH_TILES: int = 14
const PASSAGE_MIN_WIDTH_TILES: int = 2
const PASSAGE_EDGE_DEPTH_TILES: int = 1
const PASSAGE_SAFE_MARGIN_TILES: int = 42

const BORDER_THICKNESS_TILES: int = 2
const FALL_BOUNDARY_THICKNESS_TILES: int = 2
const RAISED_CLIFF_HEIGHT_TILES: int = 3
const PERIMETER_WALL_HEIGHT_TILES: int = 2
const WALL_SEGMENT_LENGTH_TILES: int = 4
const WALL_MIN_SEGMENT_TILES: int = 2
const WALL_GAP_PADDING_TILES: int = 1
const CROSSING_MARGIN_TILES: int = 2
const SIDE_EDGE_MAX_THICKNESS_TILES: int = 3

const MIN_RECT_GAP_TILES: int = 1
const PROP_BLOCK_MARGIN_TILES: int = 2
const MIN_BLOCK_SIZE_TILES: int = 11
const STARTER_RIVER_WIDTH_TILES: int = 8
const STARTER_RIVER_PADDING_TILES: int = 4
const STARTER_BRIDGE_EXTRA_WIDTH_TILES: int = 5
const STARTER_BRIDGE_PADDING_TILES: int = 1

const VOIDFIRST_ROCK_MIN_SIZE_TILES: int = 5
const VOIDFIRST_ROCK_MAX_SIZE_TILES: int = 10
const VOIDFIRST_ROCK_GAP_TILES: int = 1
const VOIDFIRST_ROCK_MARGIN_TILES: int = 2
const VOIDFIRST_FOREST_MIN_SIZE_TILES: int = 3
const VOIDFIRST_FOREST_MAX_SIZE_TILES: int = 20
const VOIDFIRST_FOREST_EDGE_MARGIN_TILES: int = 2
const VOIDFIRST_TREE_SPACING_TILES: int = 6
const VOIDFIRST_TREE_JITTER_TILES: int = 1
const VOIDFIRST_ROUTE_STEP_TILES: int = 2
const VOIDFIRST_ROAD_ROCK_CLEARANCE_TILES: int = (
	ROAD_WIDTH_TILES / 2 + VOIDFIRST_ROUTE_STEP_TILES + 1
)
const VOIDFIRST_PATH_WIDTH_TILES: int = 3
const VOIDFIRST_PATH_MAX_LEN_TILES: int = 80
const VOIDFIRST_ROAD_LINE_SPACING_TILES: int = 4
const VOIDFIRST_ROAD_LINE_NEAR_TILES: int = 1
const VOIDFIRST_ROAD_LINE_CONFINE_TILES: int = 2
const VOIDFIRST_VOID_PATCH_TILES: int = 6
const VOIDFIRST_CRATE_OFFSET_TILES: int = 9
const LEGACY_CRATE_OFFSET_TILES: int = 14
const CENTER_RESERVED_HALF_TILES: int = 13
